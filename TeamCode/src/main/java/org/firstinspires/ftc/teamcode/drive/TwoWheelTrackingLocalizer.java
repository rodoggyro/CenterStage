...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public List<Double> getWheelPositions() {
        return Arrays.asList(
                encoderTicksToInches(parallelEncoder.getCurrentPosition() / 1.987),
                encoderTicksToInches(perpendicularEncoder.getCurrentPosition() / 2.002)
        );
    }
    ...
    public List<Double> getWheelVelocities() {
        ...
        return Arrays.asList(
                encoderTicksToInches(parallelEncoder.getRawVelocity() / 1.987),
                encoderTicksToInches(perpendicularEncoder.getRawVelocity() / 2.002)
        );
    }
}
